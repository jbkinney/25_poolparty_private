...
\noindent 15 April 2026

%\vspace{0.2cm}

\noindent \textit{Subject: Manuscript submission to Bioinformatics}

%\vspace{0.2cm}

\noindent Dear Editor,

I kindly ask that you consider our manuscript, ``\textit{PoolParty: streamlined design of DNA sequence libraries in Python},'' for publication as a Journal Article in Bioinformatics.
