...
\begin{itemize}
  ...
  \item The third paper, ``A survey of sequence-to-graph mapping algorithms in the pangenome era'' \citet{Wang2025mp}, is a review article discussing the computational methods that have been developed to map sequences to pagenome graphs. It does not review algorithms or software available for desinging sequence libraries. 
