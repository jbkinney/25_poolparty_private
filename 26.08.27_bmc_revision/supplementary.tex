...
Panel D was generated with \texttt{\_include\_inline\_styles=True}, which is
omitted from the short code listing in panel A.}
...
\input{assets/table_s1_benchmark}
\input{assets/table_s2_tools}
