...
% starts at its column centre and runs up-right. tabcolsep is 10pt so adjacent
% diagonals clear each other (~19pt perpendicular separation).
% Measured: 0.0pt baseline stagger, labels within 0.8pt of their column centre.
...
\toprule
& \makebox[0pt][l]{\rotatebox[origin=lB]{45}{DNA Chisel}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{MPRA Design Tools}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{MPRAnator}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{Mutation Maker}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{Oligopool Calculator}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{\textbf{PoolParty}}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{tangermeme}} & \makebox[0pt][l]{\rotatebox[origin=lB]{45}{VaLiAnT}}\\
\midrule
