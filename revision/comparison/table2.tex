...
libraries.} \hbfull\ indicates that a tool provides the capability, \hbhalf\ that
it provides the capability subject to a stated restriction, and \hbnone\ that it
does not. A capability is counted only where the tool supplies an operation,
parameter, or mode for it, not where the user assembles it from primitives the
tool provides for other purposes. Tools were assessed in August 2026 from their
documentation and source code, and by running those that could be installed.
PoolParty is shown in bold.}
