...
% Column headers: 45deg, right-anchored in a zero-width box so they lean
% left over the blank row-label cell and add no width. tabcolsep is 10pt so
% adjacent diagonal labels clear each other (~19pt perpendicular separation).
...
\toprule
& \makebox[0pt][r]{\rotatebox[origin=rb]{45}{DNA Chisel~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{MPRA Design Tools~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{MPRAnator~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{Mutation Maker~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{Oligopool Calculator~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{\textbf{PoolParty}~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{tangermeme~}} & \makebox[0pt][r]{\rotatebox[origin=rb]{45}{VaLiAnT~}}\\
\midrule
