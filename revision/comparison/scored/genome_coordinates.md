...
sequence” (local `../../../lit_review/analyzed/Barbon2022_VaLiAnT_all.pdf`, p. 1). It further says the
...
input by the user” (`../../../lit_review/analyzed/Ghazi2018_MPRADesignTools_all.pdf`, pp. 1-2).
...
(`../../../lit_review/analyzed/Hossain2024_OligopoolCalculator.pdf`, p. 6).
...
(`../../../lit_review/analyzed/Hiraga2021_MutationMaker.pdf`, p. 2). In source, `Plasmid` has
...
(`../../../lit_review/analyzed/Zulkower2020_dnachisel.pdf`, p. 2) points to this example and does not
