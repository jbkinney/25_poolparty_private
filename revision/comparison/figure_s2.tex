...
% Requires: graphicx
% Numbering: this float takes the running figure counter, so it prints as
% "Fig. 1" in this standalone preview. In the supplement, precede it with
% \setcounter{figure}{1}\renewcommand{\thefigure}{S\arabic{figure}} to get "Fig. S2".
\begin{figure}[p]
\centering
