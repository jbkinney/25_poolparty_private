...
**Tier:** 2
**Status of this document:** FINAL. Supersedes `extractions/mpradesign.md`. Incorporates every correction from `reviews/mpradesign.md` plus an independent third re-verification pass (2026-08-10) against GitHub raw, the GitHub REST API, and the 28-page PDF.
