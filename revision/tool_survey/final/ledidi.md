...
(`extractions/ledidi.md`) with the adversarial review (`reviews/ledidi.md`) and my own
...
|---|---|---|
| PDF (preprint) | `papers/Schreiber2025_ledidi.pdf` — Schreiber, Lorbeer, Heinzl, Lu, Stark, Noble, "Programmatic design and editing of cis-regulatory elements", bioRxiv 2025.04.22.650035, posted 2025-04-23, 40 pp. (PyMuPDF text) | 2026-08-10 |
