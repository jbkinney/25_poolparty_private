...
| Kind | Ref | Retrieved |
|---|---|---|
| pdf | `papers/Barbon2022_VaLiAnT_all.pdf` (11 pp incl. Supp. Tables S1–S3, Supp. Figs S1–S2), text via PyMuPDF; all quoted passages re-extracted and re-matched for this memo | 2026-08-10 |
| prior_analysis | `revision/tool_survey/extractions/valiant.md` (original extraction memo) | 2026-08-10 |
| prior_analysis | `revision/tool_survey/reviews/valiant.md` (adversarial review) | 2026-08-10 |
