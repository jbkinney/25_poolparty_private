%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                  %%
%% PoolParty manuscript -- BMC Bioinformatics (Software article)    %%
%% Reformatted from bioinfo/main.tex onto the Springer Nature       %%
%% authoring template (sn-jnl.cls v3.1, December 2024).             %%
%%                                                                  %%
%% Class options:                                                   %%
%%   pdflatex            -- pdfLaTeX backend                        %%
%%   sn-vancouver-num    -- Vancouver numbered references           %%
%%                          (loads natbib[numbers,sort&compress]    %%
%%                           and sets \bibliographystyle automatic) %%
%%   referee             -- double line spacing                     %%
%%   lineno              -- margin line numbers (via vruler)        %%
%%   oneside             -- single-sided (see plan §A for caveat)   %%
%%                                                                  %%
%% Build:  latexmk -pdf main.tex                                    %%
%%                                                                  %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[pdflatex,sn-vancouver-num,referee,lineno,oneside]{sn-jnl}
...
multiplex assay libraries by replacing ad hoc scripts with a more structured
and reproducible framework. We expect design cards to be especially useful for
in silico experiments on genomic AI models, and PoolParty can be extended to
support new assay types and analysis strategies as they emerge.
}
...
PoolParty is available on GitHub at \url{https://github.com/jbkinney/poolparty-statetracker}. The version described in this article is archived on Zenodo at \href{https://zenodo.org/records/19445098}{DOI 10.5281/zenodo.19445098}. Code to reproduce the analyses in this paper is included in the same repository.
